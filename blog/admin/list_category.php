                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="CategoryTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="edit_category.php?id=<?php echo $d->id ?>" class="btn btn-warning" ><i class="fa fa-pencil"></i>Edit</a>

                                           
                                            <a href="delete_category.php?id=<?php echo $d->id ?>" class="btn btn-danger" onclick="return confirm('are you sure you want to delete this record?');"><i class="fa fa-trash"></i>Delete</a></td>
                                    </tr>
